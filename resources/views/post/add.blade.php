    ...
    {{-- <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function replaceText(find, replace) {
                ...
                // Thay thế cả "ι" và "&iota;"
                let updatedContent = content
                    .replace(/ι/g, "TEMP_I") // Đổi "ι" thành ký tự tạm để tránh lỗi
                    .replace(/&iota;/g, "TEMP_I") // Đổi "&iota;" thành ký tự tạm
                    .replace(new RegExp(find, "g"), replace) // Thay thế đúng giá trị cần đổi
                    .replace(/TEMP_I/g, replace); // Chuyển TEMP_I thành ký tự mong muốn
            ...
            // Nút thay thế "i" → "ι"
            document.getElementById("replaceToGreekI").addEventListener("click", function() {
                replaceText("i", "ι"); //  Đúng: thay "i" bằng "ι"
            });
