@extends('layouts.base', ['title' => 'Edit Prompt Framework'])
@section('title', 'Edit Prompt Framework')
@section('content')
<div class="container-fluid">
    <div class="card card-default">
        <div class="card-header">
            <h4 class="mb-0">Edit Prompt Framework</h4>
        </div>
        <div class="card-body">
            @if($errors->any())
            ...
            <form method="POST" action="{{ route('prompt-framework.update', $framework->id) }}">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                value="{{ old('name', $framework->name) }}" placeholder="team_sports, airline...">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="version" class="form-control"
                                value="{{ old('version', $framework->version) }}" min="1">
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="group_description" class="form-control @error('group_description') is-invalid @enderror"
                        value="{{ old('group_description', $framework->group_description) }}" placeholder="Mô tả ngắn về nhóm framework này">
                ...
                <div class="form-group">
                    ...
                    <textarea name="phase1_analyze" rows="6"
                        ...
                        placeholder="Placeholders: {domain} {audience} {terminology}">{{ old('phase1_analyze', $framework->phase1_analyze) }}</textarea>
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('prompt-framework.detail', $framework->id) }}" class="btn btn-outline-secondary">Cancel</a>
                </div>
            </form>
        </div>
    </div>
