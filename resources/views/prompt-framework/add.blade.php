            ...
            <form method="POST" action="{{ route('prompt-framework.add') }}">
                ...
                <div class="form-group">
                    ...
                    <textarea name="system_prompt" rows="5"
                        ...
                        placeholder="Direct instruction to Claude. No placeholders here — all {x} are sent literal to Claude.">{{ old('system_prompt') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea name="phase2_diagnose" rows="6"
                        ...
                        placeholder="MUST contain {content_types_block} — the list of content types for this category">{{ old('phase2_diagnose') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea name="phase3_generate" rows="6"
                        ...
                        placeholder="Placeholders: {domain} {audience} {terminology} {content_types_block} {tone_notes} {hook_style} {structure_template}. MUST have {structure_template}.">{{ old('phase3_generate') }}</textarea>
