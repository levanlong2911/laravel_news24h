...
/**
 * Tầng framework: 8 prompt_frameworks + 48 framework_content_types.
 *
 ...
 *
 * ── Vì sao tầng này gọi riêng được ───────────────────────────────────────────
 *
 * Đây là tầng DUY NHẤT an toàn để chạy trên một môi trường đã sống. Danh sách
 * category thì mỗi môi trường một khác — chúng được biên tập theo mảng nội dung
 * thật sự chạy — nên [[PromptCategoryContextSeeder]] chỉ dành cho máy cài mới.
 * Xem docblock của PromptSystemSeeder.
 */
class PromptFrameworkSeeder extends Seeder
{
    /** @return array<string, string> map name => id, cho tầng context dùng lại. */
    public function run(): array
    {
        return $this->seedFrameworks();
    }
