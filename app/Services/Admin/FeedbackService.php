    ...
    public function record(FeedbackPayload $feedback): void
    {
        try {
            PromptMetric::create([
                ...
                'haiku_input_tokens'     => $feedback->haikuInputTokens,
                'haiku_output_tokens'    => $feedback->haikuOutputTokens,
                'sonnet_input_tokens'    => $feedback->sonnetInputTokens,
                'sonnet_output_tokens'   => $feedback->sonnetOutputTokens,
                'total_cost_usd'         => $feedback->totalCostUsd,
            ]);
